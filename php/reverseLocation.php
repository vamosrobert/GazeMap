<?php
	...
	if (in_array($result['status']['code'], [401,402,403,429])) {
		...
		$handle = curl_init('https://geocoder.ls.hereapi.com/6.2/geocode.json?searchtext=' . $_REQUEST['q'] . '&gen=9&language=en&locationattributes=tz&locationattributes=tz&apiKey=API KEY');
		...
		foreach ($result['results'] as $entry) {
			...
			$temp['countryName'] = $entry['components']['country'];
